...
class RankListViewModel : ViewModel() {
    ...
    var rankList: MutableList<Any> = Collections.synchronizedList(ArrayList())
    var pageNumberBean: PageNumberBean? = null
    var mldRankData: MutableLiveData<Pair<ResponseDataType, MutableList<Any>>> = MutableLiveData()
